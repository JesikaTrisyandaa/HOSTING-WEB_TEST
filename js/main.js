...
const CLOUD_CLASSES = [
  ...
  { name: "Altostratus", label: "Awan menengah keabu-abuan" },
  { name: "Cumulonimbus", label: "Awan badai — hujan lebat dan petir" },
  { name: "Cirrocumulus", label: "Awan tinggi kecil bergerombol" },
  { name: "Cirrus", label: "Awan tinggi tipis seperti serat" },
  { name: "Cirrostratus", label: "Awan tinggi tipis merata, sering membentuk halo" },
  { name: "Cumulus Fractus", label: "Pecahan awan cumulus" },
  { name: "Cumulus", label: "Awan kapas — biasanya cuaca cerah" },
  { name: "Nimbostratus", label: "Awan tebal pembawa hujan terus-menerus" },
  { name: "Stratocumulus", label: "Awan rendah bergumpal besar" },
  { name: "Stratus", label: "Awan rendah merata seperti kabut" }
];
